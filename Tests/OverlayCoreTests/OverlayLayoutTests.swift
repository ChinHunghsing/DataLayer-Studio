...
final class OverlayLayoutTests: XCTestCase {
    func testDefaultLayoutUsesDynamicElements() {
        ...
        XCTAssertFalse(layout.elements.contains { $0.kind == .groundContactTimePercent })
        XCTAssertFalse(layout.elements.contains { $0.kind == .groundContactTimeBalance })
        XCTAssertFalse(layout.elements.contains { $0.kind == .verticalRatio })
        XCTAssertFalse(layout.elements.contains { $0.kind == .respirationRate })
        XCTAssertFalse(layout.elements.contains { $0.kind == .stepSpeedLoss })
        ...
        XCTAssertTrue(OverlayComponentID.allCases.contains(.groundContactTimeBalance))
        XCTAssertTrue(OverlayComponentID.allCases.contains(.verticalRatio))
        XCTAssertTrue(OverlayComponentID.allCases.contains(.respirationRate))
        XCTAssertTrue(OverlayComponentID.allCases.contains(.stepSpeedLoss))
