...
final class StudioModel: ObservableObject {
    ...
    private func applySuggestedOutputURLIfNeeded(for videoURL: URL) {
        guard outputURL == nil || outputURLWasAutoGenerated else { return }
        outputURL = suggestedOutputURL(for: videoURL)
    ...
    private func suggestedOutputURL(for videoURL: URL) -> URL {
