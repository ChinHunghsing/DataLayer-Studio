...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "status.outputTargetNotWritable": "Choose a writable destination folder.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "status.outputTargetNotWritable": "请选择可以写入的导出文件夹。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "status.outputTargetNotWritable": "請選擇可以寫入的匯出資料夾。",
    ...
    private static let japanese: [String: String] = [
        ...
        "status.outputTargetNotWritable": "書き込み可能な保存先フォルダを選択してください。",
