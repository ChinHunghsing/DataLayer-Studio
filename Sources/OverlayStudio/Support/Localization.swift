...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "workspace.timeline.hint": "Drag clips to move them independently; use Sync to align source times, clip handles to trim, and the in/out band to set the export range. ⌘B splits clips at the playhead, ⌫ deletes the selected clip and keeps the gap, ⇧⌫ ripple deletes.",
        ...
        "status.timelineVideoOverlap": "The export range contains overlapping video clips. Move or trim the clips so they do not overlap.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖动片段可独立调整位置；在“同步”中对齐源时间，用片段手柄裁剪，用 in/out 范围带设定导出范围。⌘B 在播放头处分割，⌫ 删除选中片段并保留间隙，⇧⌫ 波纹删除。",
        ...
        "status.timelineVideoOverlap": "导出范围内存在重叠的视频片段。请移动或裁剪片段，消除重叠。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖曳片段可獨立調整位置；在「同步」中對齊來源時間，用片段手柄裁剪，用 in/out 範圍帶設定匯出範圍。⌘B 在播放頭處分割，⌫ 刪除選取片段並保留間隙，⇧⌫ 波紋刪除。",
        ...
        "status.timelineVideoOverlap": "匯出範圍內有重疊的影片片段。請移動或裁剪片段以消除重疊。",
    ...
    private static let japanese: [String: String] = [
        ...
        "workspace.timeline.hint": "クリップは個別にドラッグ移動できます。「同期」でソース時刻を合わせ、ハンドルでトリムし、イン／アウト範囲で書き出し範囲を設定します。⌘B で再生ヘッド位置を分割、⌫ で選択クリップを削除（ギャップは残る）、⇧⌫ でリップル削除。",
        ...
        "status.timelineVideoOverlap": "書き出し範囲内で動画クリップが重なっています。重ならないように移動またはトリムしてください。",
