...
final class StudioModel: ObservableObject {
    ...
    func applySuggestedOutputURLIfNeeded(for sourceURL: URL) {
        guard outputURL == nil || outputURLWasAutoGenerated else { return }
        outputURL = suggestedOutputURL(for: sourceURL)
    ...
    private func suggestedOutputURL(for sourceURL: URL) -> URL {
