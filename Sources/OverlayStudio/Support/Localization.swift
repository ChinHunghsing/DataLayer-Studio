...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "sidebar.weather.openWeatherHint": "Requests are cached locally per activity file. Press Return or Refresh weather to retry.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "sidebar.weather.openWeatherHint": "每个运动文件的请求会缓存在本地，按回车或点击刷新天气可重试。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "sidebar.weather.openWeatherHint": "每個運動檔案的請求會快取在本機，按 Return 或點擊重新整理天氣可重試。",
        "sidebar.sync.title": "同步",
    ...
    private static let japanese: [String: String] = [
        ...
        "sidebar.weather.openWeatherHint": "リクエストはアクティビティファイルごとにローカルキャッシュされます。Return または天気を更新で再試行できます。",
