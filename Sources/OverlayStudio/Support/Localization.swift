...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "workspace.timeline.hint": "Drag clips to move them independently; use Sync to align source times, clip handles to trim, and the in/out band to set the export range. ⌘B splits selected tracks, or all tracks when none are selected; ⌫ deletes the selected clip and keeps the gap, ⇧⌫ ripple deletes.",
        "workspace.timeline.empty": "Import a video or activity to see the timeline.",
        "timeline.track.selectHelp": "Toggle this track as a blade target. With no targets, all tracks are cut.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖动片段可独立调整位置；在“同步”中对齐源时间，用片段手柄裁剪，用 in/out 范围带设定导出范围。⌘B 分割选中的轨道，未选轨道时分割全部轨道；⌫ 删除选中片段并保留间隙，⇧⌫ 波纹删除。",
        "workspace.timeline.empty": "导入视频或运动数据后，这里显示时间线。",
        "timeline.track.selectHelp": "切换此轨道是否为切割目标；未选择任何轨道时会切割全部轨道。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖曳片段可獨立調整位置；在「同步」中對齊來源時間，用片段手柄裁剪，用 in/out 範圍帶設定匯出範圍。⌘B 分割選取的軌道，未選軌道時分割全部軌道；⌫ 刪除選取片段並保留間隙，⇧⌫ 波紋刪除。",
        "workspace.timeline.empty": "匯入影片或運動資料後，這裡顯示時間軸。",
        "timeline.track.selectHelp": "切換此軌道是否為分割目標；未選取任何軌道時會分割全部軌道。",
    ...
    private static let japanese: [String: String] = [
        ...
        "workspace.timeline.hint": "クリップは個別にドラッグ移動できます。「同期」でソース時刻を合わせ、ハンドルでトリムし、イン／アウト範囲で書き出し範囲を設定します。⌘B は選択中のトラックを分割し、どのトラックも未選択なら全トラックを分割します。⌫ で選択クリップを削除（ギャップは残る）、⇧⌫ でリップル削除。",
        "workspace.timeline.empty": "動画かアクティビティを読み込むとタイムラインが表示されます。",
        "timeline.track.selectHelp": "このトラックをカット対象として切り替えます。対象がなければ全トラックを分割します。",
