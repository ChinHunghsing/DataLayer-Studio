...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "workspace.timeline.hint": "Drag the video or overlay clip to sync them; drag the in/out handles to set the export range; scrub with the playhead. Multi-clip editing arrives later.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖动视频或浮层片段左右对齐同步；拖两端 in/out 手柄设定导出范围；拖播放头擦洗预览。多片段编辑后续加入。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖曳視訊或浮層片段左右對齊同步；拖兩端 in/out 手柄設定匯出範圍；拖播放頭擦洗預覽。多片段編輯後續加入。",
    ...
    private static let japanese: [String: String] = [
        ...
        "workspace.timeline.hint": "動画またはオーバーレイのクリップをドラッグして同期。両端のイン/アウトハンドルで書き出し範囲を設定。再生ヘッドでスクラブ。複数クリップ編集は今後対応します。",
