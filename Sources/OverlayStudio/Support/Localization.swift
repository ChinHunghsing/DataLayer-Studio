...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "menu.deleteTimelineClip": "Delete Clip (Leave Gap)",
        ...
        "renderScope.singleClip": "Single Clip",
        "renderScope.individualClips": "Individual Clips",
        "help.renderScope": "Single Clip renders the export range as one file; Individual Clips renders each clip in the range as its own numbered file.",
        ...
        "status.timelineClipDeleted": "Clip deleted; the gap is kept.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "menu.deleteTimelineClip": "删除片段（保留间隙）",
        ...
        "renderScope.singleClip": "单个片段",
        "renderScope.individualClips": "多个单独片段",
        "help.renderScope": "单个片段：把导出范围渲染为一个文件；多个单独片段：把范围内每个片段各自渲染为一个带编号的文件。",
        ...
        "status.timelineClipDeleted": "已删除片段，间隙保留。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "menu.deleteTimelineClip": "刪除片段（保留間隙）",
        ...
        "output.renderScope": "渲染",
        "renderScope.singleClip": "單一片段",
        "renderScope.individualClips": "多個單獨片段",
        "help.renderScope": "單一片段：把匯出範圍渲染為一個檔案；多個單獨片段：把範圍內每個片段各自渲染為一個帶編號的檔案。",
        ...
        "status.timelineClipsSplit": "已在 %@ 分割片段。",
        "status.timelineClipDeleted": "已刪除片段，間隙保留。",
    ...
    private static let japanese: [String: String] = [
        ...
        "menu.deleteTimelineClip": "クリップを削除（ギャップを残す）",
        ...
        "renderScope.singleClip": "単一クリップ",
        "renderScope.individualClips": "個別のクリップ",
        "help.renderScope": "単一クリップは書き出し範囲を1つのファイルとしてレンダーします。個別のクリップは範囲内の各クリップを番号付きの個別ファイルとしてレンダーします。",
        ...
        "status.timelineClipDeleted": "クリップを削除しました（ギャップは残ります）。",
