...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "workspace.timeline.hint": "Read-only overview — drag the playhead to scrub. Editing arrives in a later update.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "只读概览——拖动播放头擦洗预览，编辑功能后续版本加入。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "唯讀概覽——拖曳播放頭擦洗預覽，編輯功能後續版本加入。",
    ...
    private static let japanese: [String: String] = [
        ...
        "workspace.timeline.hint": "読み取り専用の概要——再生ヘッドをドラッグしてスクラブ。編集は今後のアップデートで対応します。",
