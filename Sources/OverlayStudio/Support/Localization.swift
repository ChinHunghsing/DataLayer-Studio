...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "workspace.timeline.hint": "Drag the overlay clip to sync it to the video; scrub with the playhead. Trimming and multi-clip editing arrive later.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖动浮层片段左右对齐同步；拖播放头擦洗预览。裁剪与多片段编辑后续加入。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖曳浮層片段左右對齊同步；拖播放頭擦洗預覽。裁切與多片段編輯後續加入。",
    ...
    private static let japanese: [String: String] = [
        ...
        "workspace.timeline.hint": "オーバーレイクリップをドラッグして動画に同期。再生ヘッドでスクラブ。トリミングと複数クリップ編集は今後対応します。",
