...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "workspace.timeline.hint": "Drag clips to sync or move them; use clip handles to trim and the in/out band to set the export range; scrub with the playhead.",
        ...
        "timelineClip.inspector.readOnlyTitle": "Linked source clip",
        "timelineClip.inspector.readOnlyMessage": "Drag this clip to adjust sync. Detailed timing fields are available for clips added from the media pool.",
        ...
        "status.timelineVideoGap": "The export range contains a gap between video clips. Move or trim the clips so the range is fully covered.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖动片段可调整同步或位置；用片段手柄裁剪，用 in/out 范围带设定导出范围；拖播放头擦洗预览。",
        ...
        "timelineClip.inspector.readOnlyTitle": "联动源片段",
        "timelineClip.inspector.readOnlyMessage": "拖动这个片段可以调整同步。媒体池加入的片段才支持细节时间字段编辑。",
        ...
        "status.timelineVideoGap": "导出范围内的视频片段之间存在空隙。请移动或裁剪片段，让导出范围被完整覆盖。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖曳片段可調整同步或位置；用片段手柄裁剪，用 in/out 範圍帶設定匯出範圍；拖播放頭擦洗預覽。",
        ...
        "timelineClip.inspector.readOnlyTitle": "聯動來源片段",
        "timelineClip.inspector.readOnlyMessage": "拖曳這個片段可以調整同步。從媒體池加入的片段才支援細節時間欄位編輯。",
        ...
        "status.timelineVideoGap": "匯出範圍內的影片片段之間有空隙。請移動或裁剪片段，讓匯出範圍被完整覆蓋。",
    ...
    private static let japanese: [String: String] = [
        ...
        "workspace.timeline.hint": "クリップをドラッグして同期や位置を調整。クリップハンドルでトリムし、イン／アウト範囲で書き出し範囲を設定。再生ヘッドでスクラブできます。",
        ...
        "timelineClip.inspector.readOnlyTitle": "リンクされたソースクリップ",
        "timelineClip.inspector.readOnlyMessage": "このクリップをドラッグして同期を調整できます。詳細な時間フィールドはメディアプールから追加したクリップで編集できます。",
        ...
        "status.timelineVideoGap": "書き出し範囲内の動画クリップ間に空白があります。範囲全体を覆うようにクリップを移動またはトリムしてください。",
