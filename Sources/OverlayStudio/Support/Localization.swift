...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "sidebar.sync.subtitle": "Align recording time with activity time",
        "sidebar.mode": "Mode",
        ...
        "sync.offset": "Offset",
        "sync.fitStart": "FIT start",
        "sync.syncPoint": "Sync point",
        ...
        "status.sportStartSet": "Sport Start set at video %@; FIT starts at 0.000s.",
        ...
        "status.checkOutputSettings": "Check output settings: width/height, fps, duration, and bitrate must be in range.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "sidebar.sync.subtitle": "对齐录像时间和运动时间",
        "sidebar.mode": "模式",
        ...
        "status.sportStartSet": "运动开始已设置在视频 %@；FIT 从 0.000s 开始。",
        ...
        "status.checkOutputSettings": "请检查输出设置：宽高、帧率、时长和码率都需要在有效范围内。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "sidebar.sync.title": "同步",
        "sidebar.sync.subtitle": "對齊錄影時間和運動時間",
        "sidebar.mode": "模式",
        ...
        "status.sportStartSet": "運動開始已設定在影片 %@；FIT 從 0.000s 開始。",
        ...
        "status.checkOutputSettings": "請檢查輸出設定：寬高、影格率、時長和位元率都需要在有效範圍內。",
    ...
    private static let japanese: [String: String] = [
        ...
        "sidebar.sync.subtitle": "録画時間とアクティビティ時間を合わせる",
        "sidebar.mode": "モード",
        "sidebar.sportStart": "運動開始",
        ...
        "status.sportStartSet": "運動開始を動画 %@ に設定しました。FIT は 0.000s から開始します。",
        ...
        "status.checkOutputSettings": "出力設定を確認してください：幅/高さ、fps、長さ、ビットレートは有効範囲内である必要があります。",
