...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "inspector.summary.position": "Position",
        "inspector.summary.scale": "Scale",
        "inspector.summary.state": "State",
        "inspector.summary.visible": "Visible",
        "inspector.summary.hidden": "Hidden",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "inspector.summary.position": "位置",
        "inspector.summary.scale": "缩放",
        "inspector.summary.state": "状态",
        "inspector.summary.visible": "显示",
        "inspector.summary.hidden": "隐藏",
        "inspector.layout": "布局",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "inspector.summary.position": "位置",
        "inspector.summary.scale": "縮放",
        "inspector.summary.state": "狀態",
        "inspector.summary.visible": "顯示",
        "inspector.summary.hidden": "隱藏",
        "inspector.layout": "布局",
    ...
    private static let japanese: [String: String] = [
        ...
        "inspector.summary.position": "位置",
        "inspector.summary.scale": "拡大率",
        "inspector.summary.state": "状態",
        "inspector.summary.visible": "表示",
        "inspector.summary.hidden": "非表示",
