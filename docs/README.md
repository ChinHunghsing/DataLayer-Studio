...
> 最后整理：2026-07-18（macOS 1.0.0 已提审；GitHub Release v1.0.0 已发布）。
...
- [product-plan-1.0.0.md](product-plan-1.0.0.md) — 1.0.0 正式版产品方案 v2（可靠性收口、Feature Freeze）；产品范围与发布门槛以此为准。
