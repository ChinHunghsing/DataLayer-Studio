...
struct ContentView: View {
    ...
    private var studioCommandActions: StudioCommandActions {
        let allowsEditorShortcuts = !isEditingText
        return StudioCommandActions(
            isEditingText: isEditingText,
            isExporting: model.isExporting,
            canPlayPreview: model.canPlayPreview && allowsEditorShortcuts,
            ...
            canMoveSelectionForward: canMoveSelectedElementForward && allowsEditorShortcuts,
            canMoveSelectionBackward: canMoveSelectedElementBackward && allowsEditorShortcuts,
            canAlignSelection: model.canAlignSelectedElements && allowsEditorShortcuts,
            canDistributeSelection: model.canDistributeSelectedElements && allowsEditorShortcuts,
            canSplitTimelineClips: model.canSplitTimelineClipsAtPlayhead && allowsEditorShortcuts,
            canToggleTimelineClips: model.canToggleSelectedTimelineClipsEnabled && allowsEditorShortcuts,
            canNudgeTimelineClips: model.canNudgeSelectedTimelineClips && allowsEditorShortcuts,
            canDeleteTimelineClip: model.canDeleteTimelineSelection && allowsEditorShortcuts,
            canRippleDeleteTimelineClip: model.selectedTimelineClipIsEditable && allowsEditorShortcuts,
            canSelectAllTimelineClips: model.canSelectAllTimelineClips && allowsEditorShortcuts,
            canCopyTimelineClips: model.canCopySelectedTimelineClips && allowsEditorShortcuts,
            canCutTimelineClips: model.canCutSelectedTimelineClips && allowsEditorShortcuts,
            canPasteTimelineClips: model.canPasteTimelineClips && allowsEditorShortcuts,
            canJumpToTimelineEditPoints: model.canJumpToTimelineEditPoints && allowsEditorShortcuts,
            ...
            nudgeTimelineClips: { model.nudgeSelectedTimelineClips(byFrames: $0) },
            deleteTimelineClip: model.deleteTimelineSelection,
            rippleDeleteTimelineClip: { model.deleteSelectedTimelineClip(ripple: true) },
            selectAllTimelineClips: model.selectAllTimelineClips,
            copyTimelineClips: model.copySelectedTimelineClips,
            cutTimelineClips: model.cutSelectedTimelineClips,
            pasteTimelineClips: model.pasteTimelineClips,
            pasteInsertTimelineClips: model.pasteInsertTimelineClips,
