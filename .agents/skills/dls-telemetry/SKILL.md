---
name: dls-telemetry
description: 维护 DataLayer Studio 的 FIT/GPX 解析、TelemetrySeries、墙钟时间轴、暂停保持、距离/速度插值、COROS 海拔显示平滑和起跑、结尾、运动恢复配速平滑。修改 Sources/OverlayCore/FIT、Sources/OverlayCore/Telemetry、相关测试，或排查配速尖峰、海拔阶梯、尾段异常、距离补账、分段锚点、暂停恢复与自动对表数据问题时使用。
---
