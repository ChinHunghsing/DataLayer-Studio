...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "sidebar.weather.openWeatherHint": "Requests are cached locally per FIT. Press Return or Refresh weather to retry.",
        ...
        "preview.placeholder.title": "Choose a FIT file",
        ...
        "status.chooseVideoAndFit": "Choose a FIT file. Add a video if you want footage preview.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "sidebar.weather.openWeatherHint": "每个 FIT 的请求会缓存在本地，按回车或点击刷新天气可重试。",
        ...
        "preview.placeholder.title": "选择 FIT 文件",
        ...
        "status.chooseVideoAndFit": "请选择 FIT 文件；如果需要视频预览，可以再添加视频。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "sidebar.weather.openWeatherHint": "每個 FIT 的請求會快取在本機，按 Return 或點擊重新整理天氣可重試。",
        "sidebar.sync.title": "同步",
        ...
        "preview.placeholder.title": "選擇 FIT 檔案",
        ...
        "status.chooseVideoAndFit": "請選擇 FIT 檔案；如果需要影片預覽，可以再加入影片。",
    ...
    private static let japanese: [String: String] = [
        ...
        "sidebar.weather.openWeatherHint": "リクエストは FIT ごとにローカルキャッシュされます。Return または天気を更新で再試行できます。",
        ...
        "preview.placeholder.title": "FIT ファイルを選択",
        ...
        "status.chooseVideoAndFit": "FIT ファイルを選択してください。映像プレビューが必要な場合は動画も追加できます。",
