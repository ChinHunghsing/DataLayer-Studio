...
enum AppLocalizer {
    ...
    private static let english: [String: String] = [
        ...
        "workspace.timeline.hint": "Drag clips to move them independently; use Sync to align source times, clip handles to trim, and the in/out band to set the export range.",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖动片段可独立调整位置；在“同步”中对齐源时间，用片段手柄裁剪，用 in/out 范围带设定导出范围。",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "workspace.timeline.hint": "拖曳片段可獨立調整位置；在「同步」中對齊來源時間，用片段手柄裁剪，用 in/out 範圍帶設定匯出範圍。",
    ...
    private static let japanese: [String: String] = [
        ...
        "workspace.timeline.hint": "クリップは個別にドラッグ移動できます。「同期」でソース時刻を合わせ、ハンドルでトリムし、イン／アウト範囲で書き出し範囲を設定します。",
